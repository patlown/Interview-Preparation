...
/*
    ...
    this means we are either moving on through the list or we may be at the end, 
    check whether the next is smaller than the current if so, our node needs to be inserted here. 
    Else, we need to find the correct spot to put the node where it fits nicely between curr and next.  
    The edge cases, are empty list or one node
*/
class Solution {
